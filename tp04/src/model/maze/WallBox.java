...
/**
 * 
 * The WallBox class represents a type of {@link MazeBox} that is a wall.
 * It extends the {@link MazeBox} class and overrides some of its methods to provide specific behavior.  
 * A WallBox is not a possible position for a player to be in.
 * The color of a WallBox is always black, or gray if it is selected.
 *
 * @see MazeBox
 * @see Color
 * 
...
public class WallBox extends MazeBox {
	...
	/**
     * Returns the color of this WallBox, which is always black unless it is selected, in which case it is gray.
     * 
