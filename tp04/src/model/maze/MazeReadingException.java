...
/**
 * 
 * The MazeReadingException class represents an exception that can occur during maze reading.
 * It extends the Exception class and provides additional information about the file name, line number, and error message.
 *
...
public class MazeReadingException extends Exception {
	...
	/**
	 * Constructor for creating a MazeReadingException object with a given file name, line number, and error message.
	 * 
