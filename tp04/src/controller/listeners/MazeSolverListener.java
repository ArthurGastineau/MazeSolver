...
public class MazeSolverListener extends MazeActionListener {
	...
	/**
	 * Constructs a new {@link MazeSolverListener} with the given {@link MazeController}.
	 * 
	 * @param mazeController the {@link MazeController} to trigger the maze solve.
	 */
	...
	/**
     * Method that is called when the 'Solve' button is clicked.
     * Triggers the maze to be solved.
     * 
     * @param event the {@link ActionEvent} that triggered this method call
     */
